...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      ...
      const laserCatImage = await fetch('/api/get_unsplash_image?query=cat laser eyes')
        .then(res => res.json())
        .then(data => data.url);
      setBackgroundImage(laserCatImage);
    };
    fetchImages();
  }, []);
  ...
  return (
    <ThemeProvider theme={theme}>
      <div className="calculator-container" style={{ backgroundImage: `url(${backgroundImage})` }}>
